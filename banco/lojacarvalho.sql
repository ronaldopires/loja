...
--
-- Host: 127.0.0.1
-- Tempo de geração: 17-Mar-2020 às 14:44
...
CREATE TABLE `qc_categorias` (
  ...
  `cate_img` varchar(255) COLLATE utf8_unicode_ci NOT NULL
...
INSERT INTO `qc_categorias` (`cate_id`, `cate_nome`, `cate_slug`, `cate_img`) VALUES
(1, 'Geral', 'categoria-geral', ''),
(2, 'Camisas', 'categoria-camisas', 'cate_camisas.jpg'),
(3, 'Calças', 'categoria-calcas', ''),
(4, 'Tênis', 'categoria-tenis', 'cate_tenis.jpg'),
...
(50, 'Ronaldo', 'Pires de Carvalho', '39630231808', '0', '1992-08-29', 11, '20575984', 11, '955544918', 'ronaldo.carvalho@hotmail.com', '202cb962ac59075b964b07152d234b70', '08040740', 'Rua das Nemésias', 'Jardim Casa Pintada', 'São Paulo', 'SP', '422', '2019-10-17', '05:21:35'),
(51, 'Renata', 'Lopes', '33333333345', '1', '1985-01-25', 11, '20575984', 11, '955544918', 'renata@hotmail.com', '202cb962ac59075b964b07152d234b70', '08040740', 'Rua das Nemésias', 'Jardim Casa Pintada', 'São Paulo', 'SP', '422', '2019-01-17', '05:26:50');

-- --------------------------------------------------------

--
-- Estrutura da tabela `qc_cupons`
--
...
--
-- Extraindo dados da tabela `qc_cupons`
--

INSERT INTO `qc_cupons` (`cupom_id`, `cupom_nome`, `cupom_desconto`, `cupom_inicial`, `cupom_final`, `cupom_tipo`, `cupom_qtd`) VALUES
(10, 'Vale10', 10, '2020-02-24 12:00:00', '2020-02-26 12:00:00', 1, 50),
(11, 'Desconto10', 10, '2020-02-24 12:00:00', '2020-02-28 12:00:00', 2, 100);
...
(170, '2020-02-24', '17:54:03', 50, '20022415022350', '20022415022350', 'Não concluido', '', '', '', 21.00, NULL),
(171, '2020-02-24', '18:13:07', 50, '20022418025750', '20022418025750', 'Não concluido', '', '', '', 21.00, NULL),
(172, '2020-02-25', '14:47:29', 50, '20022514021850', '20022514021850', 'Não concluido', '', '', '', 22.50, NULL),
(173, '2020-02-25', '14:49:45', 50, '20022514023250', '20022514023250', 'Não concluido', '', '', '', 21.00, NULL),
(174, '2020-02-25', '14:51:52', 50, '20022514024050', '20022514024050', 'Não concluido', '', '', '', 21.00, NULL),
(175, '2020-02-25', '15:01:41', 50, '20022515022950', '20022515022950', 'Não concluido', '', '', '', 21.00, NULL),
(176, '2020-02-25', '15:09:33', 50, '20022515023250', '20022515023250', 'Não concluido', '', '', '', 21.00, NULL),
(177, '2020-02-25', '15:22:33', 50, '20022515022250', '20022515022250', 'Não concluido', '', '', '', 21.00, NULL),
(178, '2020-02-25', '15:34:16', 50, '20022515023350', '20022515023350', 'Não concluido', '', '', '', 21.00, NULL),
(179, '2020-02-25', '15:34:45', 50, '20022515023450', '20022515023450', 'Não concluido', '', '', '', 21.00, NULL);
...
(260, 17, 180.00, 1, '20022415022350'),
(261, 18, 159.00, 1, '20022418025750'),
(262, 31, 112.50, 2, '20022514021850'),
(263, 18, 159.00, 1, '20022514023250'),
(264, 18, 159.00, 1, '20022514024050'),
(265, 18, 159.00, 1, '20022515022950'),
(266, 18, 159.00, 1, '20022515023250'),
(267, 31, 112.50, 1, '20022515022250'),
(268, 17, 180.00, 1, '20022515023350'),
(269, 18, 159.00, 1, '20022515023450');
...
(1, 2, 'Camisa Social', 'Composta por fios mistos, a camisa 0922 possui um toque suave, com um excelente caimento e é muito confortável ao vestir.\r\nVantagens: os tecidos mistos têm a grande vantagem de não amassarem facilmente, mantendo a elegância durante o dia todo.\r\nUse com calças de sarja, jeans e bermudas.\r\nComposição:', 0.250, 80.00, '', 10, 10, 10, 'social.jpg', 'camisa-social', 79, 'Social', 'REF 0123456', 1, 'SIM', 'gratuito'),
(2, 2, 'Camisa Polo', 'Camisa Polo Manga Longa', 0.150, 60.00, '', 10, 10, 10, 'polo.jpg', 'camisa-polo', 8, 'modelo 10101010', 'REF 9874561', 1, 'SIM', 'Não'),
(3, 7, 'Calça Feminina', 'Calça Feminina ideal para você sair em qualquer lugar.', 0.150, 35.00, '', 10, 110, 10, 'calca01.jpg', 'calca-feminina', 19, 'Calça', 'Ref-0558965', 1, 'SIM', 'Não'),
...
(17, 5, 'Salto Alto Bege Mixage', 'Sapato meia pata na cor bege.\r\nModelo envernizado.\r\nBico redondo.\r\nSalto fino revestido.\r\nCÓDIGO DO FORNECEDOR: 1830-401', 0.200, 180.00, '', 10, 10, 10, 'a1c6544cff3bb06417f82c873655e706.jpg', 'salto-alto-bege-mixage', 23, 'Sapato Feminino Salto Alto Nude', 'Ref - 654441216', 1, 'SIM', 'Não'),
(18, 6, 'Tênis Nike branco e preto', 'Tênis da nike original na com branco com preto', 0.200, 159.00, '', 10, 10, 10, 'tenis-couro.jpg', 'tenis-nike-branco-e-preto', 75, 'Nike', 'Ref - 65412354', 1, 'SIM', 'Não'),
(31, 5, 'Sapato Salto Alto Bege Mixage', 'Produto Teste', 0.200, 112.50, '', 5, 5, 5, 'ac5e6a9da1782498a2bb92ed4c44d0c4.jpg', 'sapato-salto-alto-bege-mixage', 96, 'Teste', '01234', 0, 'SIM', 'Não'),
(53, 5, 'Teste', 'Teste de escolha de tamanho', 0.200, 15.00, '34,35,36,37', 0, 0, 0, 'fd6c98dc9790104c72016ebf30b06bad.jpg', 'teste', 25, 'teste', 'teste', 0, 'SIM', 'Não');
...
--
-- Estrutura da tabela `qc_user_adm`
--
...
--
-- Extraindo dados da tabela `qc_user_adm`
--
...
--
-- Índices para tabela `qc_user_adm`
--
...
--
-- AUTO_INCREMENT de tabela `qc_cupons`
--
ALTER TABLE `qc_cupons`
  MODIFY `cupom_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;
...
--
ALTER TABLE `qc_pedidos`
  MODIFY `ped_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=180;

--
-- AUTO_INCREMENT de tabela `qc_pedidos_itens`
--
ALTER TABLE `qc_pedidos_itens`
  MODIFY `item_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=270;
...
--
-- AUTO_INCREMENT de tabela `qc_user_adm`
--
ALTER TABLE `qc_user_adm`
