...
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  ...
  'unifunc' => 'content_5dd54b36d16c33_26418279',
...
function content_5dd54b36d16c33_26418279 (Smarty_Internal_Template $_smarty_tpl) {
?><div class="container-fluid">
  <div class="row no-gutters">
    ...
    <div class="container-fluid my-3 p-3">
      <div class="row no-gutters">
        <!-- Coluna de grupos de cards -->
        <div class="col p-3">
            <!-- Card 1 -->
            <div class="card">
              <img class="card-img-top" src="./tema/images/adesivo_bandeiras_PagSeguro_dez2016.jpg" alt="">
              <div class="card-body">
                <h5 class="card-title">oskdjsdjfn</h5>
