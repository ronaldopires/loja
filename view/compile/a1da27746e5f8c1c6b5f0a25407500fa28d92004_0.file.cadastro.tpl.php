<?php
/* Smarty version 3.1.34-dev-7, created on 2019-12-01 22:23:16
  from 'C:\xampp\htdocs\loja\view\cadastro.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.34-dev-7',
  'unifunc' => 'content_5de42f44df8446_60367074',
...
function content_5de42f44df8446_60367074 (Smarty_Internal_Template $_smarty_tpl) {
echo '<script'; ?>
>
            ...
            <form class="form-group p-3" action="" method="">
                    ...
                    <div class="form-inline mb-3">
                        ...
                        <div class="input-group col-4">
                            ...
                            <input id="celular" name="celular" class="form-control" required placeholder="XX XXXXX-XXXX" type="tel" maxlength="13" pattern="\[0-9]<?php echo 2;?>
\[0-9]<?php echo 4.6;?>
-[0-9]<?php echo 3.4;?>
$"
                        ...
                        <div class="input-group col-4">
                            ...
                            <input id="telefone" name="telefone" class="form-control" placeholder="XX XXXX-XXXX" type="tel" maxlength="12" pattern="\[0-9]<?php echo 2;?>
\[0-9]<?php echo 4.6;?>
-[0-9]<?php echo 3.4;?>
$"
                            OnKeyPress="formatar('## ####-####', this)">
                    ...
                    <div class="form-inline mb-3">
                        <div class="input-group col-8">
                            ...
                            <input type="email" id="email" name="email" class="form-control" placeholder="email@email.com" required pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]<?php echo 2.4;?>
$" autocomplete="off">
                        </div>
                    </div>
                    <div class="form-inline mb-3">
