        ...
        <div class="row no-gutters">
            <div class="col">
                <div class="jumbotron jumbotron-fluid m-0">
                    <div class="container">
                        <h1 class="display-7">Painel Administrativo</h1>
                ...
                <div class="collapse navbar-collapse" id="conteudoNavbarSuportado">
                    <ul class="navbar-nav mr-auto">
                        <li class="nav-item active">
                            <a class="nav-link" href="{$GET_SITE_ADM}"><i class="fas fa-home mr-2"></i>Home<span class="sr-only">(página atual)</span></a>
                        </li>
                        {if $LOGADO == true}
                        <li class="nav-item active">
                        ...
                        {/if}
                        <li class="nav-item">
                            <a class="nav-link" href="{$PAG_ADM_PRODUTOS}"><i class="fas fa-tag mr-2"></i>Produtos</a>
                        </li>
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle" href="{$PAG_CATEGORIAS}" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
